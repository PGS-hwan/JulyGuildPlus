...
import com.github.hwan.julyguildplus.api.event.GuildDeletedEvent;
...
import com.github.hwan.julyguildplus.guild.member.GuildOwner;
...
import com.github.hwan.julyguildplus.request.Receiver;
import com.github.hwan.julyguildplus.request.Request;
import com.github.hwan.julyguildplus.request.Sender;
    ...
    private void loadMembers() {
        ...
        if (yaml.contains("members")) {
            for (String memberUuidStr : yaml.getConfigurationSection("members").getKeys(false)) {
                ...
                GuildPlayer guildPlayer = JulyGuildPlus.inst().getGuildPlayerManager().getGuildPlayer(memberUuid);
