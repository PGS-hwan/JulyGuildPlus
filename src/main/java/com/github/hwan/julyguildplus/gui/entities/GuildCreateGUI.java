...
public class GuildCreateGUI extends BasePlayerGUI {
    ...
    public Inventory createInventory() {
        ...
        JulyGuildPlusLogger.debug(DebugMessage.BEGIN_GUI_LOAD_ITEM, "items.money");
        ...
        JulyGuildPlusLogger.debug(DebugMessage.END_GUI_LOAD_ITEM, "items.money");

        JulyGuildPlusLogger.debug(DebugMessage.BEGIN_GUI_LOAD_ITEM, "items.points");
        ...
        JulyGuildPlusLogger.debug(DebugMessage.END_GUI_LOAD_ITEM, "items.points");
