...
public class GuildJoinCheckGUI extends BasePageableGUI {
    ...
    public GuildJoinCheckGUI(@Nullable GUI lastGUI, @NotNull GuildMember guildMember) {
        ...
        JulyGuildPlusLogger.debug("开始: 加载 'items.request.indexes'.");
        this.itemIndexes = Util.getIndexes(thisGUISection.getString("items.request.indexes"));
        JulyGuildPlusLogger.debug("结束: 加载 'items.request.indexes'.");
    ...
    public Inventory createInventory() {
        ...
        JulyGuildPlusLogger.debug(DebugMessage.END_GUI_LOAD_ITEM, "items.page_items");
        ...
        if (getPageCount() > 0) {
            ...
            for (int i = 0; i < loopCount; i++) {
                ...
                JulyGuildPlusLogger.debug(DebugMessage.BEGIN_GUI_LOAD_ITEM, "items.request.icon");
                ...
                JulyGuildPlusLogger.debug(DebugMessage.END_GUI_LOAD_ITEM, "items.request.icon");
